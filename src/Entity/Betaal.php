...
class Betaal
{
    ...
    public function getRekCreditNr(): ?string
    {
        return $this->rek_credit_nr;
    }

    public function setRekCreditNr(string $rek_credit_nr): self
    {
        $this->rek_credit_nr = $rek_credit_nr;
